...
module.exports = {
    Query: {
        GetQuantityDailyNT: async (parent, { month, year }, context, info) => {
            const result = [];

            const listsite = ['D800 CD1 CTT', 'D800 CD2 CTT', ''];
            const startHours = [];
        ...
        GetQuantityMonthlyNT: async (parent, { start, end }, context, info) => {
            const result = [];
        ...
        GetQuantityYearlyNT: async (parent, { start, end }, context, info) => {
            const result = [];

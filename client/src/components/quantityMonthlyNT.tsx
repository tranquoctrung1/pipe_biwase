...
import { useGetQuantityMonthlyNtQuery } from '../__generated__/graphql';
...
const QuantityMonthlyNT = () => {
    ...
    const { refetch: getQuanityMonthlyNT } = useGetQuantityMonthlyNtQuery();
    ...
    const onViewClicked = () => {
        ...
        if (isAllowStartDate && isAllowEndDate) {
            ...
            getQuanityMonthlyNT({
                ...
                .then((res) => {
                    if (res?.data?.GetQuantityMonthlyNT) {
                        setLoading(false);
                        renderTable(res.data.GetQuantityMonthlyNT);
                    }
                })
    ...
    const onExportExcelClicked = () => {
        ...
        a.href = url;
        a.download = 'San_Luong_Nam_Nuoc_Tho_CTT.xlsx';
                                ...
                                <Table.Th colSpan={5}>
                                    <Center>
                                        <Text tt="uppercase" fw="bold">
                                            Bảng Tổng Hợp Sản Lượng Nước Thô
                                            ONLINE Tại Công Trình Thu
                                        </Text>
                                    </Center>
                                </Table.Th>
                            </Table.Tr>
...
export default QuantityMonthlyNT;
